...
SubCategoriaEdit, SubCategoriaDel, MarcaView, MarcaNew, MarcaEdit, marca_inactivar, UnidadMedidaView, UnidadMedidaNew, UnidadMedidaEdit, \
unidad_inactivar, ProductoView, ProductoNew, ProductoEdit, producto_inactivar
urlpatterns = [
...
#url unidad_medida#
     path('unidad/' ,UnidadMedidaView.as_view(), name='unidad_list'),
     path('unidad/new' ,UnidadMedidaNew.as_view(), name='unidad_new'),
     path('unidad/edit/<int:pk>' ,UnidadMedidaEdit.as_view(), name='unidad_edit'),
     path('unidad/inactivar/<int:id>' ,unidad_inactivar, name='unidad_inactivar'),
