...
from .models import Cliente,FacturaEnc, FacturaDet,Menu
...
class MenuView(SinPrivilegios, generic.ListView):
    model = Menu
    template_name = "fac/menu_list.html"
    context_object_name = "obj"
    permission_required="cmp.view_menu"

class MenuNew(VistaBaseCreate):
    model=Menu
    template_name="fac/menu_form.html"
    form_class=MenuForm
    success_url= reverse_lazy("fac:menu_list")
    permission_required="fac.add_menu"


class MenuEdit(VistaBaseEdit):
    model=Menu
    template_name="fac/menu_form.html"
    form_class=MenuForm
    success_url= reverse_lazy("fac:menu_list")
    permission_required="fac.change_menu"

@login_required(login_url="/login/")
@permission_required("fac.change_menu",login_url="/login/")
def menuInactivar(request,id):
