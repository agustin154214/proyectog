...
from .views import ClienteView,ClienteNew,ClienteEdit,clienteInactivar,MenuView,MenuNew,MenuEdit,menuInactivar, \
...
urlpatterns = [
    ...
    path('menus/new',MenuNew.as_view(), name="menu_new"),
    path('menus/<int:pk>',MenuEdit.as_view(), name="menu_edit"),
    path('menus/estado/<int:id>',menuInactivar, name="menu_inactivar"),
