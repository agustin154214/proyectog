    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_centro', models.CharField(max_length=100)),
                ('contacto', models.CharField(blank=True, max_length=20, null=True)),
                ('nivel', models.CharField(choices=[('Primario_Prepimario', 'Primaria_Prepimaria'), ('Básico', 'Básico')], default='Primario_Prepimario', max_length=20)),
